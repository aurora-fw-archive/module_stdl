...
#include <AuroraFW/TLib/Target/Standards.h>
    ...
    #if (!defined AFW_TARGET_CXX || defined(AFW_TARGET_CXX_11) || defined __STDC_LIMIT_MACROS)
        #ifdef __INT8_MAX__
        # undef INT8_MAX
    ...
    #if (!defined AFW_TARGET_CXX || defined(AFW_TARGET_CXX_11) || defined __STDC_CONSTANT_MACROS)
        #undef INT8_C
...
#elif defined(AFW_TARGET_COMPILER_GNU) && !defined(AFW_TARGET_STRICT_ANSI)
	#define _Bool	bool
    #ifndef AFW_TARGET_CXX_11
    	#define bool	bool
    	#define false	false
    	#define true	true
    #endif
